...
*/
axios.get('https://api.github.com/users/Los-Abreu')
    .then(response => {
...
*/
//document.querySelector('.cards').appendChild(userCardComponent(githubData));
...
const followersArray = ['Los-Abreu', 'devjaymoe', 'Diddleslip', 'leachcoding', 'Riley-Robinson', 'JChern83'];
